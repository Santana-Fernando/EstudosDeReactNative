            ...
            <ImageBackground style={styles.background} source={backgroundImage}>
                ...
                <View style={styles.formContainer}>
                    <Text style={styles.subTitle}>
                        {this.state.stageNew ? 'Crie a sua conta' : 'Informe o seus dados'}
                    </Text>
                    {this.state.stageNew && 
                    ...
                    <TouchableOpacity onPress={this.singinOrSingup} style={[styles.button, validForm ? {} : { backgroundColor: '#AAA' }]}
                        disabled={!validForm}
                    >
